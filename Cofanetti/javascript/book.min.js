...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(n){l.reject(n)}};f.prototype.then=function(h,k){function l(B,w){return"function"==typeof B?function(v){try{n(B(v))}catch(t){p(t)}}:w}var n,p,u=new f(function(B,w){n=B;p=w});this.callWhenSettled_(l(h,n),l(k,p));return u};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(n.state_){case 1:h(n.result_);
...
p){function u(v){return function(t){B[v]=t;w--;0==w&&n(B)}}var B=[],w=0;do B.push(void 0),w++,d(l.value).callWhenSettled_(u(B.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
$jscomp.polyfill("WeakMap",function(b){function c(){if(!b||!Object.seal)return!1;try{var n=Object.seal({}),p=Object.seal({}),u=new b([[n,2],[p,3]]);if(2!=u.get(n)||3!=u.get(p))return!1;u.delete(n);u.set(p,4);return!u.has(n)&&4==u.get(p)}catch(B){return!1}}function d(){}function e(n){var p=typeof n;return"object"===p&&null!==n||"function"===p}function f(n){if(!$jscomp.owns(n,h)){var p=new d;$jscomp.defineProperty(n,h,{value:p})}}function g(n){if(!$jscomp.ISOLATE_POLYFILLS){var p=Object[n];p&&(Object[n]=
function(u){if(u instanceof d)return u;Object.isExtensible(u)&&f(u);return p(u)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(b&&$jscomp.ES6_CONFORMANCE)return b}else if(c())return b;var h="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var k=0,l=function(n){this.id_=(k+=Math.random()+1).toString();if(n){n=$jscomp.makeIterator(n);for(var p;!(p=n.next()).done;)p=p.value,this.set(p[0],p[1])}};l.prototype.set=function(n,p){if(!e(n))throw Error("Invalid WeakMap key");
...
f(this,l).entry)&&l.value};e.prototype.entries=function(){return g(this,function(l){return[l.key,l.value]})};e.prototype.keys=function(){return g(this,function(l){return l.key})};e.prototype.values=function(){return g(this,function(l){return l.value})};e.prototype.forEach=function(l,n){for(var p=this.entries(),u;!(u=p.next()).done;)u=u.value,l.call(n,u[1],u[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var f=function(l,n){var p=n&&typeof n;"object"==p||"function"==p?d.has(n)?p=d.get(n):
(p=""+ ++k,d.set(n,p)):p="p_"+n;var u=l.data_[p];if(u&&$jscomp.owns(l.data_,p))for(l=0;l<u.length;l++){var B=u[l];if(n!==n&&B.key!==B.key||n===B.key)return{id:p,list:u,index:l,entry:B}}return{id:p,list:u,index:-1,entry:void 0}},g=function(l,n){var p=l.head_;return $jscomp.iteratorPrototype(function(){if(p){for(;p.head!=l.head_;)p=p.previous;for(;p.next!=p.head;)return p=p.next,{done:!1,value:n(p)};p=null}return{done:!0,value:void 0}})},h=function(){var l={};return l.previous=l.next=l.head=l},k=0;
return e},"es6","es3");
...
this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+this.getRightWidth()}};window.templeteName="pure";
window.templateArea={getLeftWidth:function(){return 0},getRightWidth:function(){return 0},getTopHeight:function(){return MiniStyle.isMini()||NeatStyle.isNeat()||!bookConfig.ToolBarVisible?0:isPC()?62:phoneTemplateArea.getTopHeight()},getBottomHeight:function(){return MiniStyle.isMini()?0:NeatStyle.isNeat()?40:bookConfig.ToolBarVisible?isPC()?bookConfig.ThumbnailsButtonVisible?62:0:phoneTemplateArea.getBottomHeight():0},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+
this.getRightWidth()}};/*
...
"{anonymous}()@"):"Unknown Stack Trace";var D=b.console&&(b.console.warn||b.console.log);D&&D.call(b.console,z,C);return m.apply(this,arguments)}}function l(m,q,r){q=q.prototype;var z=m.prototype=Object.create(q);z.constructor=m;z._super=q;r&&S(z,r)}function n(m,q){return function(){return m.apply(q,arguments)}}function p(m,q){return"function"==typeof m?m.apply(q?q[0]||e:e,q):m}function u(m,q,r){h(v(q),function(z){"undefined"!=typeof b.addEventListener?m.addEventListener(z,r,!1):m.attachEvent(z,r)})}
function B(m,q,r){h(v(q),function(z){"undefined"!=typeof b.removeEventListener?m.removeEventListener(z,r,!1):m.detachEvent(z,r,!1)})}function w(m,q){for(;m;){if(m==q)return!0;m=m.parentNode}return!1}function v(m){return m.trim().split(/\s+/g)}function t(m,q,r){if(m.indexOf&&!r)return m.indexOf(q);for(var z=0;z<m.length;){if(r&&m[z][r]==q||!r&&m[z]===q)return z;z++}return-1}function y(m){return Array.prototype.slice.call(m,0)}function x(m,q,r){for(var z=[],C=[],D=0;D<m.length;){var E=q?m[D][q]:m[D];
...
Ba;this.targetIds={};F.apply(this,arguments)}function U(m,q){var r=y(m.touches),z=this.targetIds;if(q&3&&1===r.length)return z[r[0].identifier]=!0,[r,r];m=y(m.changedTouches);var C=[],D=this.target;var E=r.filter(function(J){return w(J.target,D)});if(1===q)for(r=0;r<E.length;)z[E[r].identifier]=!0,r++;for(r=0;r<m.length;)z[m[r].identifier]&&C.push(m[r]),q&12&&delete z[m[r].identifier],r++;if(C.length)return[x(E.concat(C),"identifier",!0),C]}function ha(){F.apply(this,arguments);var m=n(this.handler,
...
La[m.pointerType]||m.pointerType,D="touch"==C,E=t(q,m.pointerId,"pointerId");z&1&&(0===m.button||D)?0>E&&(q.push(m),E=q.length-1):z&12&&(r=!0);0>E||(q[E]=m,this.callback(this.manager,z,{pointers:q,changedPointers:[m],pointerType:C,srcEvent:m}),r&&q.splice(E,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(aa,F,{handler:function(m){var q=Ma[m.type];1===q&&(this.started=!0);if(this.started){var r=y(m.touches);var z=y(m.changedTouches);q&12&&(r=x(r.concat(z),"identifier",!0));r=[r,
...
var q=this.requireFail;m=ba(m,this);-1===t(q,m)&&(q.push(m),m.requireFailure(this));return this},dropRequireFailure:function(m){if(g(m,"dropRequireFailure",this))return this;m=ba(m,this);m=t(this.requireFail,m);-1<m&&this.requireFail.splice(m,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(m){return!!this.simultaneous[m.id]},emit:function(m){function q(C){r.manager.emit(C,m)}var r=this,z=this.state;8>z&&q(r.options.event+ta(z));q(r.options.event);
...
return m},remove:function(m){if(g(m,"remove",this))return this;if(m=this.get(m)){var q=this.recognizers;m=t(q,m);-1!==m&&(q.splice(m,1),this.touchAction.update())}return this},on:function(m,q){if(m!==e&&q!==e){var r=this.handlers;h(v(m),function(z){r[z]=r[z]||[];r[z].push(q)});return this}},off:function(m,q){if(m!==e){var r=this.handlers;h(v(m),function(z){q?r[z]&&r[z].splice(t(r[z],q),1):delete r[z]});return this}},emit:function(m,q){this.options.domEvents&&Ea(m,q);var r=this.handlers[m]&&this.handlers[m].slice();
...
!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,n=0,p=0,u=0;f.animateInterval=function(B,w){k=$.easing.swing(null,n,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,n,f.parameters.height,f.parameters.height*(g-1),20);p=$.easing.swing(null,n,f.parameters.left,
f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);u=$.easing.swing(null,n,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:u+"px"});for(var v=0;v<f.side.pageArray.length;v++)if(f.side.pageArray[v])f.side.pageArray[v].onResize(k/2,l);n++;if(20<=n||B>=w){f.animateInterval.stop();f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-
f.parameters.width*g)/100;f.parameters.top=f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100;f.parameters.width*=g;f.parameters.height*=g;f.css({width:f.parameters.width+"px",height:f.parameters.height+"px",left:f.parameters.left+"px",top:f.parameters.top+"px"});for(v=0;v<f.side.pageArray.length;v++)if(f.side.pageArray[v])f.side.pageArray[v].onResize(f.parameters.width/2,f.parameters.height);f.parameters.zoomming=!1;1>=f.parameters.width*f.parameters.scale/f.parameters.naturalWidth&&
...
BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var n=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,u=e*k;if(p>windowWidth){var B=windowWidth-p-l+h*e*d.parameters.zoomArea.right/
100;l=-l-h*e*d.parameters.zoomArea.left/100}else B=-l-h*e*d.parameters.zoomArea.left/100,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100;u>windowHeight?(h=windowHeight-u-n+k*e*d.parameters.zoomArea.bottom/100,d=-n-k*e*d.parameters.zoomArea.top/100):(h=-n-k*e*d.parameters.zoomArea.top/100,d=windowHeight-u-n+k*e*d.parameters.zoomArea.bottom/100);g=Number.between(g,B,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&
...
g.y!=parseInt(f.y)){d.animateInterval&&d.animateInterval.stop();var h=0,k=0,l=0;g.x!=f.x&&(h=g.x-f.x);g.y!=f.y&&(k=g.y-f.y);d.animateInterval=function(n,p){var u=$.easing.easeOutBack(null,l,0,h,20),B=$.easing.easeOutBack(null,l,0,k,20);0<l&&(u-=$.easing.easeOutBack(null,l-1,0,h,20),B-=$.easing.easeOutBack(null,l-1,0,k,20));u=d.panForMove(d,u,B);d.setZoomParameters(d,u);l++;if(20<=l||n>=p)d.animateInterval.stop(),BookInfo.getBook().bookAttachments&&BookInfo.getBook().bookAttachments.Items.find("ZoomMap").each(function(w){w.refreshArea()}),
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,u){n(p,u,"Sine")}).animation(this,300)}.bind(this),n=function(p,u,B){if(p<u){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,u);var w=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,u);p=k(null,p,this.parameters.scale,d-this.parameters.scale,u);u={};u.scale=p;u.tran={x:B,
y:w};B=transformCSS(u);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
...
$.fn.changeButtonColor=function(b,c,d){var e=this;if("none"!=this.css("display")){var f=this;0<this.children().length&&(f=this.find("img:first"));if(window.ActiveXObject){if("complete"!=f[0].readyState){$(f).on("load",function(){try{e.changeButtonColor(b,c,d)}catch(t){}});return}}else if(!f[0].complete){$(f).on("load",function(){try{e.changeButtonColor(b,c,d)}catch(t){}});return}if(void 0!=f[0]){try{var g=$("<canvas></canvas>")[0];var h=g.getContext("2d")}catch(t){return}var k=f.width(),l=f.height();
f=f[0];void 0==c&&(c=!1);var n=getHost(f.src),p=getHost();if(n&&p!==n){if(g=f.src.replace(n,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(t){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var u=h.getImageData(0,0,k,l),B=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&u){var w=Color(b).split();k=0;for(var v=u.data.length;k<v;k+=4)0<B.data[k+3]&&(u.data[k]!=w.r&&(B.data[k]=u.data[k]/255*w.r),u.data[k+1]!=w.g&&(B.data[k+1]=
u.data[k+1]/255*w.g),u.data[k+2]!=w.b&&(B.data[k+2]=u.data[k+2]/255*w.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(t){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(y){}})}}}}};
...
$.fn.speed=function(b){function c(v){v=void 0==v.originalEvent.touches?[v]:v.originalEvent.touches;if(1<v.length)return u=!0;f=h=v[0].pageX;g=k=v[0].pageY;l=new Date;-1!=p&&window.clearInterval(p);p=window.setInterval(function(){f=h;g=k;l=new Date},300)}function d(v){if(-1==p||1==u)return!0;v=void 0==v.originalEvent.touches?[v]:v.originalEvent.touches;h=v[0].pageX;k=v[0].pageY}function e(v){if(-1==p)return!0;v=void 0!=v.originalEvent.touches==0?[v]:v.originalEvent.touches;if(1==u)return u=1<v.length,
!0;n=new Date;v=(n-l)/20;var t=h-f,y=k-g;0==v?w=B=0:(B=t/v,w=y/v);void 0!=b&&b(B,w);window.clearInterval(p);p=-1}var f,g,h,k,l,n,p=-1,u=!1,B=0,w=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(v){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(v){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,n="",p=-1,u,B,w,v=k.length-l;++p<v;)u=k.charCodeAt(p)<<
16,B=k.charCodeAt(++p)<<8,w=k.charCodeAt(++p),u=u+B+w,n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u&63);2==l?(u=k.charCodeAt(p)<<8,B=k.charCodeAt(++p),u+=B,n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u<<2&63)+"="):1==l&&(u=k.charCodeAt(p),n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(u<<4&63)+"==");return n},decode:function(k){k=String(k);for(var l=k.length,n=0,p,u,B="",w=-1;++w<l;)u="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(w)),
p=n%4?64*p+u:u,n++%4&&(B+=String.fromCharCode(255&p>>(-2*n&6)));return B},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
(function(b){function c(w,v){var t=(w&65535)+(v&65535);return(w>>16)+(v>>16)+(t>>16)<<16|t&65535}function d(w,v,t,y,x,A){w=c(c(v,w),c(y,A));return c(w<<x|w>>>32-x,t)}function e(w,v,t,y,x,A,G){return d(v&t|~v&y,w,v,x,A,G)}function f(w,v,t,y,x,A,G){return d(v&y|t&~y,w,v,x,A,G)}function g(w,v,t,y,x,A,G){return d(t^(v|~y),w,v,x,A,G)}function h(w,v){w[v>>5]|=128<<v%32;w[(v+64>>>9<<4)+14]=v;var t=1732584193,y=-271733879,x=-1732584194,A=271733878;for(v=0;v<w.length;v+=16){var G=t;var F=y;var O=x;var L=A;
t=e(t,y,x,A,w[v],7,-680876936);A=e(A,t,y,x,w[v+1],12,-389564586);x=e(x,A,t,y,w[v+2],17,606105819);y=e(y,x,A,t,w[v+3],22,-1044525330);t=e(t,y,x,A,w[v+4],7,-176418897);A=e(A,t,y,x,w[v+5],12,1200080426);x=e(x,A,t,y,w[v+6],17,-1473231341);y=e(y,x,A,t,w[v+7],22,-45705983);t=e(t,y,x,A,w[v+8],7,1770035416);A=e(A,t,y,x,w[v+9],12,-1958414417);x=e(x,A,t,y,w[v+10],17,-42063);y=e(y,x,A,t,w[v+11],22,-1990404162);t=e(t,y,x,A,w[v+12],7,1804603682);A=e(A,t,y,x,w[v+13],12,-40341101);x=e(x,A,t,y,w[v+14],17,-1502002290);
y=e(y,x,A,t,w[v+15],22,1236535329);t=f(t,y,x,A,w[v+1],5,-165796510);A=f(A,t,y,x,w[v+6],9,-1069501632);x=f(x,A,t,y,w[v+11],14,643717713);y=f(y,x,A,t,w[v],20,-373897302);t=f(t,y,x,A,w[v+5],5,-701558691);A=f(A,t,y,x,w[v+10],9,38016083);x=f(x,A,t,y,w[v+15],14,-660478335);y=f(y,x,A,t,w[v+4],20,-405537848);t=f(t,y,x,A,w[v+9],5,568446438);A=f(A,t,y,x,w[v+14],9,-1019803690);x=f(x,A,t,y,w[v+3],14,-187363961);y=f(y,x,A,t,w[v+8],20,1163531501);t=f(t,y,x,A,w[v+13],5,-1444681467);A=f(A,t,y,x,w[v+2],9,-51403784);
x=f(x,A,t,y,w[v+7],14,1735328473);y=f(y,x,A,t,w[v+12],20,-1926607734);t=d(y^x^A,t,y,w[v+5],4,-378558);A=d(t^y^x,A,t,w[v+8],11,-2022574463);x=d(A^t^y,x,A,w[v+11],16,1839030562);y=d(x^A^t,y,x,w[v+14],23,-35309556);t=d(y^x^A,t,y,w[v+1],4,-1530992060);A=d(t^y^x,A,t,w[v+4],11,1272893353);x=d(A^t^y,x,A,w[v+7],16,-155497632);y=d(x^A^t,y,x,w[v+10],23,-1094730640);t=d(y^x^A,t,y,w[v+13],4,681279174);A=d(t^y^x,A,t,w[v],11,-358537222);x=d(A^t^y,x,A,w[v+3],16,-722521979);y=d(x^A^t,y,x,w[v+6],23,76029189);t=d(y^
x^A,t,y,w[v+9],4,-640364487);A=d(t^y^x,A,t,w[v+12],11,-421815835);x=d(A^t^y,x,A,w[v+15],16,530742520);y=d(x^A^t,y,x,w[v+2],23,-995338651);t=g(t,y,x,A,w[v],6,-198630844);A=g(A,t,y,x,w[v+7],10,1126891415);x=g(x,A,t,y,w[v+14],15,-1416354905);y=g(y,x,A,t,w[v+5],21,-57434055);t=g(t,y,x,A,w[v+12],6,1700485571);A=g(A,t,y,x,w[v+3],10,-1894986606);x=g(x,A,t,y,w[v+10],15,-1051523);y=g(y,x,A,t,w[v+1],21,-2054922799);t=g(t,y,x,A,w[v+8],6,1873313359);A=g(A,t,y,x,w[v+15],10,-30611744);x=g(x,A,t,y,w[v+6],15,-1560198380);
y=g(y,x,A,t,w[v+13],21,1309151649);t=g(t,y,x,A,w[v+4],6,-145523070);A=g(A,t,y,x,w[v+11],10,-1120210379);x=g(x,A,t,y,w[v+2],15,718787259);y=g(y,x,A,t,w[v+9],21,-343485551);t=c(t,G);y=c(y,F);x=c(x,O);A=c(A,L)}return[t,y,x,A]}function k(w){var v,t="",y=32*w.length;for(v=0;v<y;v+=8)t+=String.fromCharCode(w[v>>5]>>>v%32&255);return t}function l(w){var v,t=[];t[(w.length>>2)-1]=void 0;for(v=0;v<t.length;v+=1)t[v]=0;var y=8*w.length;for(v=0;v<y;v+=8)t[v>>5]|=(w.charCodeAt(v/8)&255)<<v%32;return t}function n(w){return k(h(l(w),
8*w.length))}function p(w,v){var t=l(w),y=[],x=[];y[15]=x[15]=void 0;16<t.length&&(t=h(t,8*w.length));for(w=0;16>w;w+=1)y[w]=t[w]^909522486,x[w]=t[w]^1549556828;v=h(y.concat(l(v)),512+8*v.length);return k(h(x.concat(v),640))}function u(w){var v="",t;for(t=0;t<w.length;t+=1){var y=w.charCodeAt(t);v+="0123456789abcdef".charAt(y>>>4&15)+"0123456789abcdef".charAt(y&15)}return v}function B(w,v,t){v?t?w=p(unescape(encodeURIComponent(v)),unescape(encodeURIComponent(w))):(w=p(unescape(encodeURIComponent(v)),
unescape(encodeURIComponent(w))),w=u(w)):w=t?n(unescape(encodeURIComponent(w))):u(n(unescape(encodeURIComponent(w))));return w}"function"===typeof define&&define.amd?define(function(){return B}):"object"===typeof module&&module.exports?module.exports=B:b.md5=B})(this);String.prototype.MD5=function(b){return md5(this)};
...
function getStaticAdVisible(b){b=void 0===b?!1:b;return!global.staticAd||!global.staticAd.haveAd||isPhone()||isPad()||!global.staticAd.adPosition&&!isPhone()&&!isPad()&&b||global.staticAd.adPosition&&"Chinese"==UserGroups?!1:!0}
...
function appendParamToUrl(b,c){if(!b||"string"!==typeof b)return"";var d=$jscomp.makeIterator(b.split("#"));b=d.next().value;d=d.next().value;c=c.split("=").map(function(e){return encodeURIComponent(e)}).join("=");c=b.endsWith("?")?b+c:b.includes("?")?b+"&"+c:b+"?"+c;return d?c+"#"+d:c}
...
try{console&&console.error&&console.error.apply(console,arguments)}catch(b){}this.logForPad(String.format.apply(this,arguments),"red")}},print:function(){var b=String.format.apply(this,arguments),c=(new Date).format("hh:mm:ss.S");this.debug("[%s] %s",c,b)}}}),VERSION_NAME="6.4.9",BUILD_DATE="2024111301",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},
...
2,pageY:windowHeight/2}]});auto_player.isPlaying()&&auto_player.stop();"popular"==global.templeteName&&setLogoIndex({zIndex:"99"})},executeZoomin:function(){var b=BookInfo.getBook().showPage;b.onDoubleTap.bind(b)({pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]});auto_player.isPlaying()&&auto_player.stop();"popular"==global.templeteName&&setLogoIndex({zIndex:"0"})},zoomout:function(){this.executeZoomout();this.setAsZoomin()},zoomin:function(){this.executeZoomin();this.setAsZoomout()},onClick:function(b){BookInfo.isZoomming()||
...
function getArticleEditor(){function b(t){if(window.isExecuteGetInverseEditor)var y=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(y),t()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),t(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(x){d(x,t)},t,"")}function c(t,y,x,A,G){var F=new XMLHttpRequest;F.responseType=
void 0===A?"json":A;F.open("GET",t);F.send();F.onreadystatechange=function(){4===F.readyState&&(200===F.status||304===F.status?y&&y(F):"bookinfo"===G&&y?y():x&&x(y))};F.error=function(){x&&x(y)}}function d(t,y){v&&(clearTimeout(v),v=null);if(window.Module.isReady){var x=allocateUTF8(t.responseText),A=Module._DeString(x),G=UTF8ToString(A);G=eval(G);Module._free(x);Module._FreeMemory(A);e(G);y();window.runArticleEditor&&delete window.runArticleEditor}else v=setTimeout(function(){d(t,y)},100)}function e(t){(window.articleListConfig=
t)?g(t):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(t){window.articleConfig=t.response})}function g(t){for(var y=[],x=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],G=0;G<x;G++){for(var F=A&&A.length&&A[G]?A[G].index:G,O=[],L=0;L<t.length;L++)(t[L].articles?t[L].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
...
x:I.rect.x,y:I.rect.y,width:I.rect.width,height:I.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:I.rect.pageWidth,pageHeight:I.rect.pageHeight}:""}I&&H.articleTextList&&H.articleTextList.length&&(H=k(H),M=h(H,I),O.push(M))}});y.push(O)}console.log("currentPageEditor",JSON.parse(JSON.stringify(y)));window.inverseEditor=y}function h(t,y){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
downColor:"#4997ee",outColor:"#4997ee",overAlpha:"0.3",downAlpha:"0.5",outAlpha:"0"});var x=window.articleConfig.hotArea;return{action:{triggerEventType:"mouseDown",actionType:"com.mobiano.flipbook.pageeditor.TAnnoActionShowArticle",articleConfig:t,linkTarget:"showArticle"},annotype:"com.mobiano.flipbook.pageeditor.TAnnoLink",annoId:"202211710188056",isInverse:!0,alpha:"1",overColor:x.overColor,downColor:x.downColor,outColor:x.outColor,overAlpha:x.overAlpha,downAlpha:x.downAlpha,outAlpha:x.outAlpha,
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:y,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(t){t=JSON.parse(JSON.stringify(t));t.articleTextList.map(function(y){"text"===y.type&&
(y.text=y.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return y});return{articleId:t.articleId,newTime:t.newTime,title:t.title,subTitle:t.subTitle,author:t.author,categoryId:t.categoryId,articleTextList:t.articleTextList}}function l(t,y){var x=[];t.forEach(function(A){-1!==y&&(A.pageIndex===y||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(G){return G.pageIndex===y}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,y),A.length&&(x=[].concat($jscomp.arrayFromIterable(x),$jscomp.arrayFromIterable(A)))):
x.push(A.rect))});return x}function n(t,y){var x="";t.forEach(function(A){if(-1!==y&&(A.pageIndex===y||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===y}).length))if(""===x)x=A.mergeList&&A.mergeList.length?n(A.mergeList,y):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var G=[x].concat(A.mergeList);x=n(G,y)}x.rect.x>A.rect.x&&(x.rect.x=A.rect.x);x.rect.y>A.rect.y&&(x.rect.y=A.rect.y);x.rect.endX<A.rect.endX&&(x.rect.endX=A.rect.endX);x.rect.endY<
A.rect.endY&&(x.rect.endY=A.rect.endY);x.rect.width=x.rect.endX-x.rect.x;x.rect.height=x.rect.endY-x.rect.y}});return x}function p(t){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,t,u):u(t)}function u(t){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,t,B):B(t)}function B(t){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var y=bookConfig.periodsConfigPath;y=y.replace("%periodicalId%",window.book_visit.periodicalId);c(y,t,w)}else w(t)}
function w(t){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,t):t&&t()}var v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){return t.return(new Promise(function(y,x){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?y():window.runArticleEditor||window.inverseEditor?y():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(x=bookConfig.bookBaseURL)?(x.endsWith("/")||(x+="/"),c(x+"bookinfo.js",function(A){A&&A.response&&
(eval(A.response),window.book_visit=book_visit);b(function(){window.runArticleEditor=1;y()})},"","text","bookinfo")):b(function(){window.runArticleEditor=1;y()}):(window.runArticleEditor=1,y(),window.runArticleEditor&&delete window.runArticleEditor))}))})}
...
l.$parent==b&&(f=l.getWidth()+22,g+=l.getWidth()+22)}g+=2;h=b.children().length;Number.between(Math.floor((e-4-f)/(h-1)),10,65);var n=f=0,p=0;for(h=0;h<this.bookmarkList.count();h++)if(k=this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k),l.$parent==b){var u={};g>=e?(0<p&&(n=l.getWidth()>2*p/3?n+(p/2+10):n+(p-l.getWidth()/2+10)),u[c]=n,p=l.getWidth()):(u[c]=f,f+=l.getWidth()+22);u["z-index"]=d*k.pageIndex;l.setPosition(u)}},show:function(){this.visible=!0;this.refresh()},hide:function(){this.hideLeftBar();
...
var globalImages=[],canvasData=[],canvasLoad=function(b,c,d,e,f,g){var h=$("<canvas class='test'></canvas>"),k=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){e&&e(c,c,h,b);l.jumpToEnd()})};(function(){var l=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){$.ajax({url:c,type:"GET",dataType:"json",success:function(p){canvasData[b]="string"==typeof p?JSON.parse(p):p;globalImages[b]=[];(function(){if(0==canvasData[b].resources.length)k();else for(var u=0,
B=0;B<canvasData[b].resources.length;B++)if(1!=canvasData[b].resources[B].type)u++,u>=canvasData[b].resources.length&&k();else{var w=new Image;w.src=getResource(b,B);globalImages[b][B]=w;w.onload=function(){u++;u>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});n.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,n,p,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(w){bookConfig.largePageWidth/bookConfig.largePageHeight>w[0].naturalWidth/w[0].naturalHeight?w.css({width:"auto",height:"100%"}):w.css({width:"100%",height:"auto"})};for(n=0;n<c.length;n++)p=c[n],p=p.removeStartFrom("?"),u=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),u.attr("src",p),k.append(u),u[0].onload=function(w){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},u[0].onerror=function(w){h++;h==c.length&&
e&&e(c,c,k,b)};B.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){h=function(u,B){return!u||passwardType()&&bookConfig.excludeFrontPages&&B>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),p.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),n=$("<img src='"+l+"'/>"),n[0].onload=function(){e&&e(l,c,this,b)},p.return();loadJavascript(c,function(u){var B=dataBase64Str(b,d,u);$("<img src='"+B+"'/>")[0].onload=function(){e&&e(B,c,this,b)}},function(){});
return p.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(!window.printLoadStack)return p.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;n=new PdfLoadingTask(b,d,k,l,function(u){var B=u.toDataURL("image/png"),w=$("<img src='"+B+"'/>");w[0].onload=function(){e&&e(B,B,w,b)}}.bind(h));window.printLoadStack.push(n);return p.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
JsLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(1==u.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,u.yield(getPageDir(b,c,originTotalPageCount),2);k=u.yieldResult;h.imageURL=k;if(!h.fillImageOrNot(k,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),
function(){this.create(b,c,d)}.bind(h),function(){}),u.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return n=dataBase64Str(b,c),h.$image=$("<img src='"+n+"'/>"),h.$image[0].onload=function(){d&&d(n,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),u.return();p=h;loadJavascript(k,function(B){var w=dataBase64Str(b,c,B);p.$image=$("<img src='"+
w+"'/>");p.$image[0].onload=function(){d&&d(w,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(p)},function(){});u.jumpToEnd()})},fillImageOrNot:function(b,c){return!b||"string"!=typeof b||passwardType()&&bookConfig.excludeFrontPages&&c>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:!0},zoomIn:function(){(isPhone()||isPad())&&bookConfig.highDefinitionConversion&&this.highDefinition()},
...
k=this.loadAllImage;(function(){var l=this,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return p.yield(getPageDir(b,c,originTotalPageCount),2);n=p.yieldResult;$.ajax({url:n,type:"get",async:!1,success:function(u){canvasData[b]=configForPages.pages[b-1].data;globalImages[b]=[];k(b,h)}.bind(l),error:function(){}});p.jumpToEnd()})})()},loadAllImage:function(b,c){for(var d=0,e=0;e<canvasData[b].resources.length;e++)if(1!=canvasData[b].resources[e].type)d++,d>=canvasData[b].resources.length&&
c();else{var f=new Image;f.src=getResource(b,e);globalImages[b][e]=f;f.onload=function(){d++;d>=canvasData[b].resources.length&&c()}}},zoomIn:function(){},zoomOut:function(){},onResize:function(){},renderCnvas:function(b,c,d,e,f,g,h){if(bookConfig.usePdfJs&&d){this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0);this.render&&(this.render.taskPool.stop(),this.render=void 0);var k=canvasData[e],l=k.page,n=f,p=g,u=f/g,B=l.width/l.height;.01<=u-B&&!PageInfo.pageIsStrech(this.pageIndex)&&
(n=l.width*g/l.height);-.01>=u-B&&!PageInfo.pageIsStrech(this.pageIndex)&&(p=f*l.height/l.width);if(!window.devicePixelRatio||isPC())window.devicePixelRatio=1;f=n*devicePixelRatio/l.width;d.attr("width",n*devicePixelRatio);d.attr("height",p*devicePixelRatio);d.css("height",p+"px");d.css("width",n+"px");d.css({position:"absolute",top:0,bottom:0,left:0,right:0,margin:"auto"});g=d[0].getContext("2d");g.save();g.imageSmoothingEnabled=!0;l.background&&(g.fillStyle=int2color(l.background),g.fillRect(0,
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),n=Math.ceil(k/2),p=b.getContext("2d"),u=p.getImageData(0,0,f,g),B=p.createImageData(c,d);u=u.data;for(var w=B.data,v=0;v<d;v++)for(var t=0;t<c;t++){for(var y=4*(t+v*c),x,A=0,G=0,F=0,O=0,L=0,H=0,I=(v+.5)*k,K=Math.ceil((v+1)*k),M=Math.floor(v*k);M<K;M++){var W=Math.abs(I-(M+.5))/n,Z=(t+.5)*h;W*=W;for(var aa=Math.ceil((t+1)*h),T=Math.floor(t*h);T<aa;T++)if(x=Math.abs(Z-(T+.5))/l,x=
Math.sqrt(W+x*x),!(1<=x)){x=2*x*x*x-3*x*x+1;var U=4*(T+M*f);H+=x*u[U+3];G+=x;255>u[U+3]&&(x=x*u[U+3]/250);F+=x*u[U];O+=x*u[U+1];L+=x*u[U+2];A+=x}}w[y]=F/A;w[y+1]=O/A;w[y+2]=L/A;w[y+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
e.onload=function(){g=this.result+g;var l=new FileReader;l.onload=function(){g+=this.result;var n=f.slice(0,4E3),p=new FileReader;p.onload=function(){var u=new Uint8Array(this.result);for(i=0;i<this.result.byteLength;++i)u[i]=255-u[i];u=new Blob([new Blob([u.buffer]),f.slice(4E3,f.size)],{type:"application/pdf"});u=window.URL.createObjectURL(u);c({url:u,password:g})};p.readAsArrayBuffer(n)};l.readAsText(k)};e.readAsText(h)}};d.send()}.bind(this))}
...
this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(n);n.$image[0].onerror=function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(n);bookConfig.textSharpening&&(u="-webkit-optimize-contrast",_agent_.browser.firefox&&(u="-moz-crisp-edges"),_agent_.browser.opera&&(u="-o-crisp-edges"),n.$image.css({"image-rendering":u,"-ms-interpolation-mode":"nearest-neighbor"}));B.jumpToEnd()})},
...
c,d,e,f,g){var h=this,k,l,n,p,u,B;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){if(1==w.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,h.callback=d,h.$images=[],h.loadArray=[],w.yield(getPageDir(b,c,originTotalPageCount),2);k=w.yieldResult;h.imagesURL=k;l=0;n=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);p=function(v){l++;this.$images.removeElement(v);this.callback&&l==k.length&&this.callback(k,
k,this.$images,this.index)}.bind(h);for(u=0;u<k.length;u++)B=-1<k[u].indexOf(".svg")?new ImageArrayLoadSvg(b,k[u],c,n,p,e,f,g,u):new ImageArrayLoadImage(b,k[u],c,n,p,e,f,g,u),h.$images.push(B.$image),h.loadArray.push(B);w.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&this.loadArray[c].zoomIn(b)},zoomOut:function(b,c){for(var d=0;d<this.loadArray.length;d++)this.loadArray[d].zoomOut&&this.loadArray[d].zoomOut(b,c)},onResize:function(b,c){this.pageWidth=
...
parseInt(g)){k=!1;break a}}}catch(l){}k=!0}k?BookRestrict.unLimitPages[c]="restrict":BookRestrict.unLimitPages[c]="open"}}catch(l){}}}}),Page=Class({create:function(b,c,d,e){this._super(b,c,d,e);this.renderPage();this.addFlipShadow()},remove:function(){this.sideImage&&this.sideImage.remove();this.side.remove();this.sideImage=this.side=void 0;this.pageBackground&&this.pageBackground.destroy();this.render&&(this.render.taskPool.stop(),this.renderInterval&&(window.clearInterval(this.renderInterval),
this.renderInterval=void 0));this.hasReader&&this.destroySlider()},destroy:function(){this.pageBackground&&this.pageBackground.destroy();this.sideImage=this.side=void 0;this.hasReader&&this.destroySlider()},hasReader:function(){return window.readerConfig&&0<window.readerConfig.pages.length&&window.readerConfig.pages.length>=this.pageIndex&&(this.hasReaderItems()||window.inverseEditor&&window.inverseEditor.length&&window.inverseEditor[this.pageIndex-1]&&window.inverseEditor[this.pageIndex-1].length)?
!0:!1},hasReaderItems:function(){return window.readerConfig.pages[this.pageIndex-1]&&(window.readerConfig.pages[this.pageIndex-1].insertPageLink&&window.readerConfig.pages[this.pageIndex-1].insertPageLink.length||window.readerConfig.pages[this.pageIndex-1].items&&window.readerConfig.pages[this.pageIndex-1].items.length||window.readerConfig.pages[this.pageIndex-1].hasSceneAnime||window.readerConfig.pages[this.pageIndex-1].background&&window.readerConfig.pages[this.pageIndex-1].background.isEnable||
...
var c=this.$container.width(),d=this.$container.height(),e=BookInfo.getBook().flipBook.parameters?BookInfo.getBook().flipBook.parameters.scale:1,f=this.selectStartPoint[0]/(c*e),g=this.selectStartPoint[1]/(d*e),h=b.deltaX,k=b.deltaY;bookConfig.upsideOnMobile()&&(h=b.deltaY,k=-b.deltaX);return{left:f,top:g,right:(this.selectStartPoint[0]+h)/(c*e),bottom:(this.selectStartPoint[1]+k)/(d*e)}},getRealPoint:function(b){if((b=b.originalEvent&&b.originalEvent.changedTouches?b.originalEvent.changedTouches:
b.changedTouches?b.changedTouches:[b])&&!(3<=b.length)){var c=this.$container.offset().left,d=this.$container.offset().top,e=BookInfo.getBook().flipBook.parameters?BookInfo.getBook().flipBook.parameters.scale:1;this.$container.width();e*=this.$container.height();var f=b[0].pageX;b=b[0].pageY;return bookConfig.upsideOnMobile()?[b-d,e-(f-c)]:[f-c,b-d]}},onResize:function(){}}).extend(PageAttachment),PageAnimation=Class({create:function(b){this.$container=b.$container;this.pageIndex=b.pageIndex;this.page=
...
g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var p=0;k=function(){n(p,25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,u){n(p,u,"Sine")}.animation(this,l)}.bind(this);var n=function(p,u,B){if(!b)return!1;var w=b.pageWidth,v=b.pageHeight,t=$.easing["easeInOut"+B],y=$.easing["easeOut"+B];B=y(null,p,g,b.toPoint.x-g,u);y=y(null,p,h,b.toPoint.y-h,u);b.dragMoveToFlip||(B=t(null,p,g,b.toPoint.x-g,u),y=bookConfig.FlipDirection?
f*Math.sqrt(v*v-B*B):v-f*Math.sqrt(w*w-B*B));p<u?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:y}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",[d]),k.stop())}.bind(this);e()}},setFlipInterval:function(){this.flipInterval=function(){if(!this.flipIntervalManager.flipInterval||!this.flipIntervalManager.flipInterval.stop){if(this.flipPageManager&&this.flipPageManager.array&&0!=this.flipPageManager.array.length)for(var b=0;b<this.flipPageManager.array.length;b++){var c=
...
(this.moveByMousePosition=!0,this.btnMoveMode.empty().append(getImage(this.moveByDragUrl)).attr("title",getLanguage("btnDragToMove","Move by mouse drag")));this.btnMoveMode.changeButtonColor(bookConfig.iconColor)},destroy:function(){this.bar.remove()},zoomUp:function(b){var c=BookInfo.getBook().showPage;if(!c.parameters.eventCancel&&!c.parameters.zoomming){bookConfig.AnnotationButtonVisible&&global.annotationCookie&&global.annotationCookie.saveCookie();c.scale=c.parameters.toScale;var d=Math.min(c.parameters.naturalHeight*
c.maxScale/c.parameters.height,1.2*parseFloat(c.scale));d!=c.scale&&(b||(b={pointers:[{pageX:windowWidth/2,pageY:windowHeight/2},{pageX:windowWidth/2,pageY:windowHeight/2}]}),c.parameters.origin=c.mathOrigin(c,b),c.originObj(c,c.parameters.origin),c.animateToScale(c,d,b,300))}},zoomDown:function(b){var c=BookInfo.getBook().showPage;if(!c.parameters.eventCancel&&!c.parameters.zoomming){bookConfig.AnnotationButtonVisible&&global.annotationCookie&&global.annotationCookie.saveCookie();b||(b={pointers:[{pageX:windowWidth/
2,pageY:windowHeight/2},{pageX:windowWidth/2,pageY:windowHeight/2}]});c.scale=c.parameters.toScale;c.parameters.origin=c.mathOrigin(c,b);c.originObj(c,c.parameters.origin);var d=c.parameters.naturalHeight/c.parameters.height,e=.8*parseFloat(c.scale);e<=d&&(c.parameters.zoomOut=!0);c.animateToScale(c,Math.max(d,e),b,300)}},zoomOut:function(){var b=BookInfo.getBook().showPage;b.onDoubleTap.bind(b)({pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]});StateSynchronous.instance().findButtons("ZoomButton",
!0).each(function(c){c.setAsZoomin();c.executeCallback()})}}),CatalogZoomControlBar=Class({}).extend(ZoomControlBar),ZoomMap=Class({create:function(b){this.book=b;this.maxWidth=80;this.maxHeight=100;this.pageHeight=this.pageWidth=this.height=this.width=0;this.doublePage=!1;this.init();this.initEvent()},init:function(){this.map=$("<div class='thumbnail_map'></div>");bookConfig.FlipDirection?(this.imageLeft=$("<img class='map_img map_img_up'></img>"),this.imageRight=$("<img class='map_img map_img_down'></img>")):
...
this.maxHeight?(this.pageWidth=this.maxWidth,this.pageHeight=bookConfig.largePageHeight*this.maxWidth/bookConfig.largePageWidth):(this.pageHeight=this.maxHeight,this.pageWidth=bookConfig.largePageWidth*this.maxHeight/bookConfig.largePageHeight);bookConfig.FlipDirection?(this.height=this.book.doublePage?2*(this.pageHeight+1):this.pageHeight,this.width=this.pageWidth+2):(this.height=this.pageHeight+2,this.width=this.book.doublePage?2*(this.pageWidth+1):this.pageWidth);var b=20+bookConfig.rightMargin,
c=templateArea.getTopHeight()+10+bookConfig.topMargin;this.map.css({left:"auto",right:b+"px",top:c,width:this.width+"px",height:this.height+"px"});$(".map_img").css({width:this.pageWidth+"px",height:this.pageHeight+"px"});this.doublePage=this.book.doublePage},fillContent:function(b){this.visible&&(b=BookInfo.getCurrentPages(),this.doublePage=1<b.length,bookConfig.FlipDirection?(this.doublePage?(this.fillImage(this.imageLeft,b[0]),this.fillImage(this.imageRight,b[1]),this.imageLeft.show(),this.imageRight.show(),
this.imageLeft.css({"border-bottom":"none"})):(this.fillImage(this.imageLeft,b[0]),this.imageLeft.show(),this.imageRight.hide(),this.imageLeft.css({"border-bottom":"1px solid gray"})),this.height=this.pageHeight,this.doublePage&&(this.height=2*(this.pageHeight+1)),this.map.css({height:this.height+"px"})):(this.doublePage?(this.fillImage(this.imageLeft,b[0]),this.fillImage(this.imageRight,b[1]),this.imageLeft.show(),this.imageRight.show(),this.imageLeft.css({"border-right":"none"})):(this.fillImage(this.imageLeft,
b[0]),this.imageLeft.show(),this.imageRight.hide(),this.imageLeft.css({"border-right":"1px solid gray"})),this.width=this.pageWidth,this.doublePage&&(this.width=2*(this.pageWidth+1)),this.map.css({width:this.width+"px"})),$(".map_img").css({width:this.pageWidth+"px",height:this.pageHeight+"px"}))},fillImage:function(b,c){b&&pageResourceLoad(c,"thumb",function(d){b.attr("src",d)})},refreshArea:function(){if(this.book.showPage){var b=this.book.showPage,c=b.width(),d=b.height();b=getTransform(b[0]);
var e=this.getBookPosition();if(1==this.book.doublePage&&0==this.doublePage)if(bookConfig.FlipDirection){d/=2;var f=BookInfo.getBook().getCurrentPageIndex();BookInfo.isLeftPage(f,!0)||(e.top+=d)}else c/=2,f=BookInfo.getBook().getCurrentPageIndex(),BookInfo.isLeftPage(f,!0)||(e.left+=c);f=-(e.left+b.x);var g=-(e.top+b.y);b=(f+windowWidth)/c;e=(g+windowHeight)/d;c=Math.max(0,f/c);d=Math.max(0,g/d);b=Math.min(1,b);e=Math.min(1,e);f=this.width;this.mapCursor.css({left:c*f,top:d*this.height,width:(b-c)*
f,height:(e-d)*this.height})}},getBookPosition:function(){var b=this.book.showPage.css("left");b=parseInt(b.replace("px",""));var c=this.book.showPage.css("top");c=parseInt(c.replace("px",""));return{left:b,top:c}},initEvent:function(){var b=new Hammer.Manager(this.mapCursor[0]);b.add(new Hammer.Pan);b.on("panstart panmove panend pancancel",this.onPan.bind(this))},onPan:function(b){if(b&&b.pointers&&1==b.pointers.length){var c=this.book.showPage.width()/this.width,d=this.book.showPage.height()/this.height;
c=this.book.showPage.panForMove(this.book.showPage,-b.deltaX*c,-b.deltaY*d,!1);this.refreshArea();this.mapCursor.css({"background-color":"RGBA(245,225,135,0.8)",cursor:"move"});if("panend"==b.type||"pancancel"==b.type)this.mapCursor.css({"background-color":"RGBA(250,240,185,0.5)",cursor:"default"}),this.book.showPage.setZoomParameters(this.book.showPage,c),this.book.showPage.restrictInBoundary(this.book.showPage,this.refreshArea.bind(this))}}}),FlipShotBar=Class({create:function(b){this.flipShotObj=
...
2&&(bookConfig.RightToLeft||b>=originTotalPageCount-1&&this.setVisible(!1)))},refresh:function(){}}),setCurrentIndexTextField=function(b){b=getShownPageNumberInfo(b);$("#guidPageIndex").html("<b>"+b+"</b>");$("#currentPageIndexTextField")&&$("#currentPageIndexTextField")[0]&&!$("#currentPageIndexTextField")[0].onFocus&&$("#currentPageIndexTextField").val(b);for(var c=$(".currentPageIndexTextField"),d=0;d<c.length;d++)c[d]&&!c[d].onFocus&&$(c[d]).val(b)},getShownPageNumberInfo=function(b){BookInfo.isDoublePage();
b=BookInfo.getCurrentPages();for(var c=originTotalPageCount,d="",e=0;e<b.length;e++){var f=getShownPageNumber(b[e]);0!=e&&d!=f&&(d+="-");d!=f&&(d+=f)}0==b.length&&(d=getShownPageNumber(1));bookConfig.totalPagesCaption&&(c=bookConfig.totalPagesCaption);return rightToLeft?c+"/"+d:d+"/"+c},getShownPageArray=function(){var b=bookConfig.pageNumberCaption+"",c=originTotalPageCount;";"==b.substr(b.length-1,1)&&(b=b.substr(0,b.length-1));b=b.split(";");for(var d=[],e=0;e<b.length;e++)if(""!=b[e]&&void 0!=
b[e]){var f=b[e].split(":");if(f[0])if(f[1]||(f[1]=""),-1<f[1].indexOf("+")){var g=f[0];g.indexOf("-");g=g.split("-");var h=g[0];g=g[1];h=parseInt(h);var k=g?parseInt(g):c;f=getPageNumberFormat(f[1]);for(var l=h;l<=k;l++){var n=(l-h)*f.addition+f.startPage;g="";0==f.type&&(g=n+"");1==f.type&&(g=parseRoman(n));2==f.type&&(g=parseRoman(n).toLowerCase());d[l]=String.format(f.page,g)}}else if(!isNaN(f[0]))h=parseInt(f[0]),d[h]=void 0==f[1]?"":f[1];else if(-1<f[0].indexOf("-"))for(g=f[0],g.indexOf("-"),
g=g.split("-"),h=g[0],g=g[1],h=parseInt(h),k=g?parseInt(g):c,l=h;l<=k;l++)d[l]=void 0==f[1]?"":f[1]}return d};
...
function getUserInfo(){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){(b=bookConfig.bookBaseURL)&&!b.endsWith("/")&&(b+="/");c=window.location.pathname.split("/");if(4<=c.length&&(d=window.location.host.toLowerCase(),d.match(/fliphtml5.com|flipbuilder/)))try{$.ajax({url:b+"../getuserinfo.js",type:"get",crossDomain:!0,success:function(f){eval(f);window.userInfo=userInfo},error:function(f){console.log(f)}})}catch(f){console.log(err)}e.jumpToEnd()})}
